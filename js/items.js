...
$(document).ready(function () {
  ...
  $('#item-2-site').dblclick(function () {
    window.open('https://l33t.bio/xqi');
  });


  $('#item-2-github').dblclick(function () {
    window.open('https://github.com/33yc');
  });



  $('#item-2-steam').dblclick(function () {
    window.open('https://github.com/33yc/Steam-Checker');
  });

  $('#item-2-heroin').dblclick(function () {
    window.open('https://github.com/33yc/HeroinSIP');
  });
